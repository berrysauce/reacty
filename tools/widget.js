document.write(`
    ...
    <script>
        ...
        function returnFeedback(feedback) {
            let url = "https://reacty-testing.deta.dev/api/[webkey]/report/" + feedback
            fetch(url)
